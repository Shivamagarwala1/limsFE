        ...
        <>
            <div>
                ...
                >
                    ...
                    <div>RateList Upload By Excel</div>
                </div>
            ...
            <div>
                ...
                >
                    ...
                    <div>RateList Upload By ExcelHeader Details</div>
                </div>

                <table className="table-auto border-collapse w-full text-xxs text-left mb-2">

                    <thead style={{ background: activeTheme?.menuColor, color: activeTheme?.iconColor }} className='overflow-scroll'>
                        <tr>
                            {rateListUploadByExcelHeader.map((data, index) => (
                                <td
                                    key={index}
