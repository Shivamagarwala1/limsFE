...
export default function AppointmentBooking() {
    ...
    const [patientRegistrationData, setPatientRegistrationData] = useState({
        ...
        "assignedBy": 0,
        "cancleBy": 0,
        "assignedDate": "2025-03-19T05:19:18.451Z",
        "cancelDate": "2025-03-19T05:19:18.451Z",
        "rescheduleDate": "2025-03-19T05:19:18.451Z",
        "rescheduleBy": 0
    });
    ...
    const validateForm = () => {
        ...
        if (!patientRegistrationData.address) errors.address = true;
        if (!patientRegistrationData.pinCode) errors.pinCode = true;
                    ...
                    "addAppointment": [
                        {
                            ...
                            "assignedBy": 0,
                            "cancleBy": 0,
                            "assignedDate": new Date('0001-01-01 00:00:00Z'.replace(/:\d+Z$/, 'Z'))
                                .toLocaleString("en-US", { hour12: true }).replace(",", "").replace(/(\d+)\/(\d+)\/(\d+)/, (_, m, d, y) => `${y}-${m.padStart(2, "0")}-${d.padStart(2, "0")}`),
                            "cancelDate": new Date('0001-01-01 00:00:00Z'.replace(/:\d+Z$/, 'Z'))
                                .toLocaleString("en-US", { hour12: true }).replace(",", "").replace(/(\d+)\/(\d+)\/(\d+)/, (_, m, d, y) => `${y}-${m.padStart(2, "0")}-${d.padStart(2, "0")}`),
                            "rescheduleDate": new Date('0001-01-01 00:00:00Z'.replace(/:\d+Z$/, 'Z'))
                                .toLocaleString("en-US", { hour12: true }).replace(",", "").replace(/(\d+)\/(\d+)\/(\d+)/, (_, m, d, y) => `${y}-${m.padStart(2, "0")}-${d.padStart(2, "0")}`),
                            "rescheduleBy": 0
                        }
                    ]
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-2  mt-2 mb-1  mx-1 lg:mx-2">
                        ...
                        <div className="relative flex-1">
                            <CustomDropdown
                                ...
                                value={patientRegistrationData?.appointmentType}
                                options={[
                                    { label: 'Select Option', value: 0, disabled: true },
                                    { label: 'Home Collections', value: 1 },
                                    { label: 'Centre Visite', value: 2, },
                                ]}
                                onChange={(e) => handelOnChangePatientRegistration(e)}
                                defaultIndex={0}
                                activeTheme={activeTheme}
                            // isMandatory={patientRegistrationDataError?.appointmentType}
                            />
                        </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-2  mt-2 mb-1  mx-1 lg:mx-2">
                        ...
                        <div className="relative flex-1">
                            ...
                            <CustomTextBox
                                ...
                                label="Address"
                                isDisabled={false}
                                isMandatory={patientRegistrationDataError?.address}
                            />
                        </div>
                        ...
                        <div className="relative flex-1">
                            ...
                            <CustomNumberInput
                                ...
                                maxLength={6}
                                label="Pin Code"
                                isMandatory={patientRegistrationDataError?.pinCode}
                            />
                        </div>
