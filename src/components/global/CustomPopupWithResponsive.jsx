    ...
    return (
        <>
            <div className="flex justify-center items-center h-[100vh] inset-0 fixed bg-black bg-opacity-50 z-40">
                <div className={`${popuptype === "medium" ? "w-80 md:w-[500px] max-h-[50vh]" : popuptype === "large" ? "w-80 md:w-[900px] max-h-[50vh]" : "w-80 max-h-[50vh]"} z-50 shadow-2xl bg-white rounded-lg animate-slideDown flex flex-col`}>
