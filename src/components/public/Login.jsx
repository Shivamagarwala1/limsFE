...
export default function Login() {
    ...
    return (
        ...
        <div className="bg-cover bg-center w-full h-screen sm:h-full md:h-screen overflow-hidden"
            ...
            <div className='flex flex-col lg:flex-row justify-center items-center lg:items-stretch sm:mx-20 pt-64 sm:pt-60 md:pt-64 lg:pt-[22rem] xl:pt-[20rem] 2xl:pt-[28rem] 4k:pt-[48rem]'>
