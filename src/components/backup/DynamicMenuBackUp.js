...
const DynamicMenu = ({ routes }) => {
    ...
    const visibleParentCount = 5; // Number of parent items to display at a time
    const visibleChildCount = 5; // Number of child items to display at a time
    ...
    useEffect(() => {
        ...
        if (activeRoute) {
            ...
            //!<== !== ==> console.log(activeChildRoute?.navigationURL);                               
            //localStorage.setItem("activeUrl", JSON.stringify(activeChildRoute?.navigationURL));
